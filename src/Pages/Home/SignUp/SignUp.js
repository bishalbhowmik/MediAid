        ...
        <div className='flex flex-col items-center justify-center h-[100vh]'>
            <div className='shadow-lg p-10 rounded w-[500px] signup'>
                <form onSubmit={handleSubmit(handleSignup)}>
                    <h2 className='text-black text-center text-3xl'>Sign Up as a patient</h2>
                    <div>
                    ...
                    <div className='mb-4'>
                        ...
                        <input type="password" {...register("password", {
                            ...
                            pattern: { value: /(?=.*?[A-Z])(?=.*?[a-z])(?=.*?[0-9])./, message: 'Password should contain at least one uppercase,lowercase & number' }
                        })} name="password" className="input input-bordered w-full" />
                        {errors.password && <p className='text-gray-600 text-xs mt-2'>{errors.password?.message}</p>}
